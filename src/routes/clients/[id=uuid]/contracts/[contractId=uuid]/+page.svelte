...
<Page title={contract.title} {subtitle} crumbs={data.crumbs} width="wide">
	{#snippet actions()}
		...
		<Button
			href={resolve('/clients/[id=uuid]/contracts/[contractId=uuid]/edit', {
	...
	<Section title={m.rate_card_section_heading()}>
		{#snippet actions()}
			<a
				href={resolve('/clients/[id=uuid]/contracts/[contractId=uuid]/rate-cards/new', {
					id: contract.client.id,
					contractId: contract.id
				})}
	...
	<Section title={m.clause_note_section_heading()}>
		{#snippet actions()}
			<a
				href={resolve('/clients/[id=uuid]/contracts/[contractId=uuid]/clause-notes/new', {
					id: contract.client.id,
					contractId: contract.id
				})}
				...
				{#each data.clauseNotes as note (note.id)}
					<Card>
						<a
							...
							href={resolve(
								'/clients/[id=uuid]/contracts/[contractId=uuid]/clause-notes/[clauseNoteId=uuid]/edit',
	...
	<Section title={m.contract_ceiling_section_heading()}>
		{#snippet actions()}
			<a
				href={resolve('/clients/[id=uuid]/contracts/[contractId=uuid]/ceilings/new', {
					id: contract.client.id,
					contractId: contract.id
				})}
	...
	<Section title={m.renewal_assumption_heading()}>
		{#snippet actions()}
			<a
				href={resolve('/clients/[id=uuid]/contracts/[contractId=uuid]/renewal-assumption/edit', {
					id: contract.client.id,
					contractId: contract.id
				})}
				class="underline"
